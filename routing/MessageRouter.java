...
public abstract class MessageRouter {
	...
	public static final int BUS_BUSY = -6;
	public static final int IS_BACKOFF = -7;
...
//		}
	...
	public Message messageTransferred(String id, DTNHost from) {
		...
		World.BROADCAST_BUS --;
		int index = 0;
		for(int i =0;i<World.BROADCAST_MESSAGE.size();i++)
		{
			Message m = World.BROADCAST_MESSAGE.get(i);
